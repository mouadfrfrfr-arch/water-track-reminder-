...
export function CupSmallIcon({ size = 28, className }: IconProps) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M7 8h10l-1 12a2 2 0 0 1-2 2h-4a2 2 0 0 1-2-2L7 8zm1.5-2a3.5 3.5 0 0 1 7 0v.5h-7V6z" />
    </svg>
  );
}
...
export function BottleIcon({ size = 28, className }: IconProps) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M10 2h4v2a2 2 0 0 0 .6 1.4l1.2 1.2A4 4 0 0 1 17 9.4V20a2 2 0 0 1-2 2H9a2 2 0 0 1-2-2V9.4a4 4 0 0 1 1.2-2.8l1.2-1.2A2 2 0 0 0 10 4V2z" />
    </svg>
  );
}
